...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull ScrollView rootView, @NonNull Button btnSave,
      @NonNull EditText etEmail, @NonNull EditText etName, @NonNull EditText etPassword,
      @NonNull Spinner spRole, @NonNull TextView tvRegisterTitle) {
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((ScrollView) rootView, btnSave, etEmail, etName,
          etPassword, spRole, tvRegisterTitle);
    }
